...
export default function Page() {
    return (
        <div>
            <Header>Zodiac Tail: A Game of Cat and Mouse</Header>
            <div className="mt-[48px] mx-[24px] mb-[72px]">
                ...
                <div className="w-[100%] flex justify-center my-8">
                    <video width="320" height="240" controls>
                        <source src="/assets/b/zodiactail/walkthrough.mp4" type="video/mp4" />
                    </video>
                </div>
                ...
                <div className="ml-4">
                    ...
                    <div className="mb-4">
                        • PC Version: ( <a href="/assets/b/zodiactail/ZodiacTail-MacOS-0.2.13-beta.zip" className="text-blue-600 hover:text-purple-400">
                            MacOS ARM
                        </a> / <a href="/assets/b/zodiactail/ZodiacTail-Windows-0.2.13-beta.zip" className="text-blue-600 hover:text-purple-400">
                            Windows x86
                        </a> / <a href="/assets/b/zodiactail/ZodiacTail-Linux-0.2.13-beta.zip" className="text-blue-600 hover:text-purple-400">
                            Linux x86
                        </a> ) </div>
                    <div className="mb-4">
                        • Signatures: ( <a href="/assets/b/zodiactail/ZodiacTail-MacOS-0.2.13-beta.zip.asc" className="text-blue-600 hover:text-purple-400">
                            MacOS ARM
                        </a> / <a href="/assets/b/zodiactail/ZodiacTail-Windows-0.2.13-beta.zip.asc" className="text-blue-600 hover:text-purple-400">
                            Windows x86
                        </a> / <a href="/assets/b/zodiactail/ZodiacTail-Linux-0.2.13-beta.zip.asc" className="text-blue-600 hover:text-purple-400">
                            Linux x86
                        </a> ) </div>
