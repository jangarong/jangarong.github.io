...
*Posted originally on ghost, edited on August 9th, 2025*
...
It basically means using the GitHub CI/CD which deploys and generates the URLs, you can have your UIs running on:
