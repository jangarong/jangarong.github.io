...
*Imported from ghost, edited on July 19th, 2025.*
...
[![](/assets/b/log/noogler/1.jpg)](/assets/b/log/noogler/1.jpg)

And now, here's the office!

[![](/assets/b/log/noogler/2.jpg)](/assets/b/log/noogler/2.jpg)
[![](/assets/b/log/noogler/3.jpg)](/assets/b/log/noogler/3.jpg)
[![](/assets/b/log/noogler/4.jpg)](/assets/b/log/noogler/4.jpg)
[![](/assets/b/log/noogler/5.jpg)](/assets/b/log/noogler/5.jpg)
[![](/assets/b/log/noogler/6.jpg)](/assets/b/log/noogler/6.jpg)
...
Google 24/7! Maybe this is how they get you to stay, and is probably why out of the FAANGs Google has a much better 
retention rate than the others.
...
internal infrastructure (specific to GCP) or other means (K8s/Docker/Google Workspace?!). I've dealt with a similar in Trend Micro, 
whenever I tried to make a virtual machine or any instance with open ports or a deprecated/vulnerable OS Image, 
Trend Micro detects it and removes the VM. I see its use case though! Very cool product but also I have never 
dealt with cloud security in depth, so ... good luck to me? I didn't know Blockchain/Email Security, so let's hope I can quickly 
pick up these concepts fast as well!

**That is all!** Now that I'm here, I can see why so many people want to get into Google...
